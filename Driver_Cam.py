...
def Contri():
   tkinter.messagebox.showinfo("Contributors","Piyush\n")
...
but6=Button(frame,padx=5,pady=5,width=39,bg='white',fg='black',relief=GROOVE,command=driver_detection,text=' Driver Drowsiness Detection',font=('helvetica 15 bold'))
but6.place(x=5,y=470)

but7=Button(frame,padx=5,pady=5,width=5,bg='white',fg='black',relief=GROOVE,text='EXIT',command=exit,font=('helvetica 15 bold'))
but7.place(x=210,y=546)
